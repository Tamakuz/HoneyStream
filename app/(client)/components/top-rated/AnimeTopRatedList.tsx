...
import { getAnimeTopRated } from "@/app/(client)/service/animes.service";
import CardAnime from "../CardAnime";
import { Skeleton } from "@/components/ui/skeleton";
import { useInView } from "react-intersection-observer";
import AnimateList from "../AnimateList";

const AnimeTopRatedList = () => {
  ...
  const {
    ...
    queryFn: ({ pageParam = 1 }) => getAnimeTopRated(pageParam),
...
export default AnimeTopRatedList;