...
import { getCommentsAnime } from "../../service/animes.service";
import { client } from "../../lib/hc";
interface CommentAnimeProps {
  contentId: string;
}
const CommentAnime = ({ contentId }: CommentAnimeProps) => {
  ...
  const {
    ...
    queryKey: ["commentsAnime", contentId],
    queryFn: () => getCommentsAnime(contentId),
    enabled: !!contentId,
